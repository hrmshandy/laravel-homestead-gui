...
<template>
  <div class="settings">
    <settings :value="setting" :category="category"></settings>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      setting() {
        return this.$store.state.settings.all[this.$route.params.setting];
      },
    },
    data() {
      return {
    ...
    updated() {
      this.category = this.$route.params.setting;
    },
    mounted() {
      this.category = this.$route.params.setting;
    },
